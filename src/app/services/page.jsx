...
export const metadata = {
    title: "Our Services | Care Nest",
    description:
        "Explore Care Nest services, connect with caregivers, and manage your care requests efficiently.",
    openGraph: {
        title: "Our Services | Care Nest",
        description:
            "Explore Care Nest services, connect with caregivers, and manage your care requests efficiently.",
        url: "https://www.carenest.com/services",
        images: [
            {
                url: "https://i.ibb.co.com/TxDRFv75/image.png", // services page
                width: 1200,
                height: 630,
                alt: "Care Nest Services Preview",
            },
        ],
    },
    twitter: {
        ...
        description:
            "Explore Care Nest services, connect with caregivers, and manage your care requests efficiently.",
        images: ["https://i.ibb.co.com/TxDRFv75/image.png"],
    },
};
